...
let publishedOrders = lokalStorage("get", "publishedOrders");
...
export const getAddressByString = createAsyncThunk(
  "bing/getAddressByString",
...
export const getRouteInfo = createAsyncThunk(
  ...
  async (destinationCoords, thunkAPI) => {
    try {
      ...
      const { travelDistance, travelDurationTraffic } =
